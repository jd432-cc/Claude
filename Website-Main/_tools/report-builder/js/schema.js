/* =============================================================
   ...
   the DOCX payload. Adding the other five report types is a matter
   of writing another one of these, not another form.
...
export const SCHEMA = {
  ...
  sections: [
...

    {
      ...
      gate: { field: 'src.referenceLapChecked', message: 'Confirm the reference lap is clean to unlock the rest of the report.' },
      fields: [
...
export const ALL_FIELDS = SCHEMA.sections.flatMap(s => s.fields || []);
